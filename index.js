...
const compareColor = "background-color: white";
...
const playGame = () => {
  ...
  const selectColZero = () => {
    colZero.addEventListener("click", () => {
      if (
        document.getElementById("squ-42").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-42").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-35").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-35").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-28").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-28").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-21").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-21").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-14").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-14").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-7").getAttribute("style") === compareColor
      ) {
  ...
  const selectColOne = () => {
    colOne.addEventListener("click", () => {
      if (
        document.getElementById("squ-43").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-43").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-36").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-36").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-29").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-29").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-22").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-22").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-15").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-15").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-8").getAttribute("style") === compareColor
      ) {
  ...
  const selectColTwo = () => {
    colTwo.addEventListener("click", () => {
      if (
        document.getElementById("squ-44").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-44").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-37").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-37").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-30").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-30").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-23").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-23").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-16").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-16").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-9").getAttribute("style") === compareColor
      ) {
  ...
  const selectColThree = () => {
    colThree.addEventListener("click", () => {
      if (
        document.getElementById("squ-45").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-45").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-38").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-38").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-31").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-31").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-24").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-24").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-17").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-17").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-10").getAttribute("style") === compareColor
      ) {
  ...
  const selectColFour = () => {
    colFour.addEventListener("click", () => {
      if (
        document.getElementById("squ-46").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-46").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-39").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-39").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-32").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-32").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-25").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-25").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-18").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-18").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-11").getAttribute("style") === compareColor
      ) {
  ...
  const selectColFive = () => {
    colFive.addEventListener("click", () => {
      if (
        document.getElementById("squ-47").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-47").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-40").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-40").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-33").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-33").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-26").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-26").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-19").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-19").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-12").getAttribute("style") === compareColor
      ) {
  ...
  const selectColSix = () => {
    colSix.addEventListener("click", () => {
      if (
        document.getElementById("squ-48").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-48").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-41").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-41").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-34").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-34").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-27").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-27").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-20").getAttribute("style") === compareColor
      ) {
        document.getElementById("squ-20").style = `background-color: ${color}`;
      } else if (
        document.getElementById("squ-13").getAttribute("style") === compareColor
      ) {
